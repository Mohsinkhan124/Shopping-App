...
class Blackshoes extends StatefulWidget {
  const Blackshoes({super.key});

  @override
  State<Blackshoes> createState() => _BlackshoesState();
}

class _BlackshoesState extends State<Blackshoes> {
   int quantity = 1;
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: const DecorationImage(
                      image: AssetImage('assets/Black.webp'), // Your image path
                      fit: BoxFit.cover,
                    ),
                  ),
                  child: Align(
