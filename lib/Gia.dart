...
class Gia extends StatefulWidget {
  const Gia ({super.key});

  @override
  State<Gia> createState() => _GiaState();
}

class _GiaState extends State<Gia> {
  int quantity = 1;
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: const DecorationImage(
                      image: AssetImage('assets/Gia.jpg'), // Your image path
                      fit: BoxFit.cover,
                    ),
                  ),
                  child: Align(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.fromLTRB(0, 0, 20, 350),
